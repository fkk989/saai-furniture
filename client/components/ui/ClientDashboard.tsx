    ...
    >
      ...
      >
        <ul className="flex flex-col text-white">
          <li
            onClick={() => {
              navigate.push("/dashboard/add-client");
            }}
            className=" hover:bg-[rgba(0,0,0,0.6)] text-[18px] box-content p-[5px] pl-[10px] pr-[10px] rounded-md"
          >
            Add client
          </li>
          ...
          <li
            onClick={() => {
              navigate.push("/dashboard/add-blog");
            }}
            className=" hover:bg-[rgba(0,0,0,0.6)] text-[18px] box-content p-[5px] pl-[10px] pr-[10px] rounded-md"
          >
            Add Blog
