...
export const Navbar: React.FC<NavbarProp> = ({ location }) => {
  ...
  useEffect(() => {
    console.log(typeof window.scrollY, window.scrollY);
  ...
  return (
    <div
      ...
      }  fixed top-0 w-screen h-[100px] flex justify-between items-center transition-all delay-300 duration-300 pl-[20px] pr-[100px] bg-white shadowww z-[2]`}
    >
      <Navigator to="/">
